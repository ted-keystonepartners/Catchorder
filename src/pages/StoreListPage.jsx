...
const StoreListPage = () => {
  ...
  const filteredStores = useMemo(() => {
    ...
    return stores.filter(store => {
      ...
      const matchesDistrict = districtFilter === 'all' || store.district === districtFilter;
      
      // 날짜 필터 추가
      let matchesDate = true;
      if (dateFilter !== 'all') {
        const storeDate = new Date(store.createdAt || store.updatedAt);
      ...
      return matchesSearch && matchesStatus && matchesRegion && matchesDistrict && matchesDate;
    });
  }, [stores, searchTerm, statusFilter, regionFilter, districtFilter, dateFilter]);
